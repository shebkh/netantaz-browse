...
document.addEventListener("DOMContentLoaded", function () {
    const element = document.getElementById("weather-banner");
    if (element) {
...
document.addEventListener("DOMContentLoaded", async function () {
    ...
    try {
        ...
        const city = locationData.city || "Baku";
        console.log(city);
...
function updateWeatherUI(weather) {
    ...
    if (weather.toLowerCase().includes("yağış")) {
        mainWeather = "yağış";
    }
    if (weather.toLowerCase().includes("qar")) {
        mainWeather = "qar";
    }
    ...
    switch (mainWeather) {
        ...
        case "səma":
            ...
            src = "./img/sun.svg"
            bannerBgSrc = "./img/bg_img.png"
            sunSrc = "./img/sun_rotate.png?v1"
            sunImg.src = sunSrc
            cloudTwo.innerHTML = ""
            cloudOne.innerHTML = ""
            break;
        case "yağış":
            animation = "Buludlar nə qədər sıx olsa da, Mood Bites ləzzəti ilə gününüz işıqlansın!";1
            weatherContainer.style.background = "linear-gradient(180deg, #A5C5F2 0%, #DBE8FA 100%)";
        ...
        case "qar":
            ...
            break;
        default:
            animation = "Məlumat alına bilmədi";
