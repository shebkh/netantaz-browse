// Set front and back images for each rectangle
const rect1Front = document.querySelector('#rect1 .front');
const rect1Back = document.querySelector('#rect1 .back');
const rect2Front = document.querySelector('#rect2 .front');
const rect2Back = document.querySelector('#rect2 .back');
const rect3Front = document.querySelector('#rect3 .front');
const rect3Back = document.querySelector('#rect3 .back');
const rect4Front = document.querySelector('#rect4 .front');
